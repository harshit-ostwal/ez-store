      ...
      <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
        ...
        <div className="flex flex-1 flex-col gap-5 lg:sticky lg:top-6 lg:self-start">
          ...
          <div className="flex items-center gap-4">
            <Heading size="h4" className="text-primary font-semibold">
              ${discountedPrice}
            </Heading>
          ...
          <div className="grid grid-cols-2 gap-x-6 gap-y-4">
            {[
              ...
              { label: "Min. Order", value: `${minimumOrderQuantity} units` },
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {reviews.map((review, i) => (
            <div key={i} className="flex flex-col gap-3 rounded-4xl border p-6">
